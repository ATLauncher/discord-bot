...
export const topics: Topic[] = [
    ...
    },
    {
        ...
        title: 'Java 7 needed for older Minecraft versions',
        description:
            "In order to run some really old modpacks, you need to use Java 7.\n\nFirst you need to download and install Java 7. You can grab it from [here](https://www.azul.com/downloads/?version=java-7-lts&os=windows&architecture=x86-64-bit&package=jre), make sure you note the folder that it installed to.\n\nOnce installed, go into the settings for the particular instance that is having the issue (**don't do this in the launchers main settings page**), then in the Java tab, change the option to `Use Java provided by Minecraft` to No, and then in the Java Path box, you need to put in the path to where your Java 7 install is.",
    },
];
...
class HowCommand extends BaseCommand {
    ...
    async execute(message: Discord.Message) {
        ...
        const replyWith = topics.find((t) => t.command === topic);
