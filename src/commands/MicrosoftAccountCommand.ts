...
To stay up to date on our support for Microsoft accounts, take a look at https://github.com/ATLauncher/ATLauncher/issues/415 which contains our progress towards supporting them. You can sign up for notifications on that GitHub issue to know when we release support.`,
        );
